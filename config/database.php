    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'strict' => false,
            'engine' => null,
            // Connection pooling for low-spec hardware (i3-2100, 4GB RAM)
            'options' => [
                PDO::ATTR_PERSISTENT => true,  // Reuse connections instead of creating new ones
                PDO::ATTR_TIMEOUT => 5,        // Fail fast on slow queries
