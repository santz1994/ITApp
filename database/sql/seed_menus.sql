...
(1, 'Dashboard', 'home', 'fa fa-dashboard', 1, 1, NOW(), NOW());
...
(2, 'Assets', 'fa fa-desktop', 2, 1, NOW(), NOW());

-- Insert Assets submenu items
INSERT INTO `menus` (`id`, `label`, `route`, `icon`, `parent_id`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(3, 'All Assets', 'assets.index', 'fa fa-list', 2, 1, 1, NOW(), NOW()),
(4, 'Add New Asset', 'assets.create', 'fa fa-plus', 2, 2, 1, NOW(), NOW()),
...
INSERT INTO `menus` (`id`, `label`, `icon`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(7, 'Tickets', 'fa fa-ticket', 3, 1, NOW(), NOW());

-- Insert Tickets submenu items
INSERT INTO `menus` (`id`, `label`, `route`, `icon`, `parent_id`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(8, 'All Tickets', 'tickets.index', 'fa fa-list', 7, 1, 1, NOW(), NOW()),
(9, 'Create Ticket', 'tickets.create', 'fa fa-plus', 7, 2, 1, NOW(), NOW()),
(10, 'My Tickets', 'user.tickets.index', 'fa fa-user', 7, 3, 1, NOW(), NOW());
...
INSERT INTO `menu_role` (`menu_id`, `role_id`, `can_view`, `created_at`, `updated_at`)
SELECT 10, id, 1, NOW(), NOW() FROM roles WHERE name = 'user';

-- Insert Meeting Rooms Parent Menu
INSERT INTO `menus` (`id`, `label`, `icon`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(11, 'Meeting Rooms', 'fa fa-calendar', 4, 1, NOW(), NOW());

-- Insert Meeting Rooms submenu items
INSERT INTO `menus` (`id`, `label`, `route`, `icon`, `parent_id`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(12, 'All Bookings', 'meeting-room-bookings.index', 'fa fa-list', 11, 1, 1, NOW(), NOW()),
(13, 'New Booking', 'meeting-room-bookings.create', 'fa fa-plus', 11, 2, 1, NOW(), NOW()),
(14, 'Calendar View', 'meeting-room-bookings-calendar', 'fa fa-calendar-o', 11, 3, 1, NOW(), NOW());
...
INSERT INTO `menus` (`id`, `label`, `icon`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(16, 'Reports', 'fa fa-bar-chart', 6, 1, NOW(), NOW());

-- Insert Reports submenu items
INSERT INTO `menus` (`id`, `label`, `route`, `icon`, `parent_id`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(17, 'Asset Report', 'reports.assets', 'fa fa-file-pdf-o', 16, 1, 1, NOW(), NOW()),
(18, 'Ticket Report', 'reports.tickets', 'fa fa-line-chart', 16, 2, 1, NOW(), NOW());
...
INSERT INTO `menus` (`id`, `label`, `route`, `icon`, `parent_id`, `order_index`, `is_active`, `created_at`, `updated_at`) VALUES
(20, 'Users', 'admin.users.index', 'fa fa-users', 19, 1, 1, NOW(), NOW()),
(21, 'Roles & Permissions', 'admin.roles.index', 'fa fa-shield', 19, 2, 1, NOW(), NOW()),
(22, 'Menu Management', 'admin.menus.index', 'fa fa-bars', 19, 3, 1, NOW(), NOW()),
(23, 'System Settings', 'admin.settings.index', 'fa fa-gear', 19, 4, 1, NOW(), NOW());
...
SELECT CONCAT('Successfully created ', COUNT(*), ' menu-role permissions') AS result FROM menu_role;
