    ...
    <div class="row">
            ...
            <div class="box box-primary">
                ...
                <form action="{{ route('admin.menus.update', $menu->id) }}" method="POST" id="editMenuForm">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('icon') ? 'has-error' : '' }}">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa {{ $menu->icon }}" id="icon-preview"></i></span>
                                <input type="text" 
                                       class="form-control" 
                                       id="icon" 
                                       name="icon" 
                        ...
                        <div class="form-group {{ $errors->has('order_index') ? 'has-error' : '' }}">
                            ...
                            <input type="number" 
                                   ...
                                   name="order_index" 
                                   placeholder="0" 
                                   value="{{ old('order_index', $menu->order_index) }}"
                                   min="0">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('admin.menus.permissions', $menu->id) }}" class="btn btn-info pull-right">
        ...
        <div class="col-md-4">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="is_external" value="1" {{ old('is_external', $menu->is_external) ? 'checked' : '' }}>
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-info-circle"></i> Menu Information</h3>
                </div>
                <div class="box-body">
                    <table class="table table-condensed">
                        ...
                        <tr>
                            <th>Submenus:</th>
                            <td>
                                <span class="badge bg-blue">{{ $menu->children->count() }}</span>
                            </td>
                        </tr>
                        @endif
                    </table>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <ul>
                        <li>Click "Manage Permissions" button to assign roles</li>
                        <li>Only users with assigned roles can see this menu</li>
                    </ul>
                </div>
            </div>
        </div>
